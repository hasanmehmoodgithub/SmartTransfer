...
class HomeFragment : Fragment() {
    ...
    private fun setupClickListeners() {
        ...
        binding.remotelyShare.setOnClickListener {
            startActivity(Intent(requireContext(), RemotelyShareActivity::class.java))

        }

        binding.androidToIos.setOnClickListener {
            startActivity(Intent(requireContext(), MobileToPcActivity::class.java))
        }

        binding.mobileToPcCard.setOnClickListener {

            StoragePermissionBottomSheet().show(childFragmentManager, "test")
            //startActivity(Intent(requireContext(), MobileToPcActivity::class.java))
