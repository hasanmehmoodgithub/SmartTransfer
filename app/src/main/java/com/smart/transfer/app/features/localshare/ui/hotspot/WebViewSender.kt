...
import com.smart.transfer.app.databinding.ActivityWebViewSenderBinding
...
class WebViewSender : BaseActivity() {

    private var fileServerMulti: LocalFileServer? = null
    private val port = 8080
    private var isServerRunning = false

    private lateinit var binding: ActivityWebViewSenderBinding  // View Binding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityWebViewSenderBinding.inflate(layoutInflater)
...
//        binding.lottieAnimationView.playAnimation()
        ...
        // Automatically start the server on create
...
// Convert paths to File objects
    ...
    private fun startFileServerList(files: List<File>) {
        try {
            ...
            fileServerMulti?.stop()
            fileServerMulti = LocalFileServer(port, files)
